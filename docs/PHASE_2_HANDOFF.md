...
| fastprop_vs_cowell_250km            | relative 10-day altitude-drop difference (drag-only, no J2) |  0.000622845 |   0.01  | True     |
| decay_scales_inverse_B              | drop(B=60)/drop(B=30) at 250 km storm, 30 d                 |  0.49724     | nan     | True     |
